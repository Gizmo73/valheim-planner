...
function graustenAsset(type, wm, hm) {
  const tilesW = wm;
  const tilesH = hm;
...
export const Grausten1x1 = graustenAsset('grausten-1x1', 1, 1);
export const Grausten2x1 = graustenAsset('grausten-2x1', 2, 1);
export const Grausten4x1 = graustenAsset('grausten-4x1', 4, 1);
export const Grausten2x2 = graustenAsset('grausten-2x2', 2, 2);
export const Grausten4x4 = graustenAsset('grausten-4x4', 4, 4);
